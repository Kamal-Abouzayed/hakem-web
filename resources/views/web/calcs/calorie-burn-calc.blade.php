...
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="main-pregnancy-calculator">
                        ...
                        <div class="title-pregnancy-calculator">
                            <h2>{{ $pageTitle }}</h2>
                            <p>{{ __('Use the calorie burn calculator to estimate the number of calories burned during routine daily activities or a workout based on activity duration.') }}
                            </p>
                        </div>
                        ...
                        <div class="sub-pregnancy-calculator">
                            ...
                            <form id="calorie-form">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-calculator">
                                            <input type="number" placeholder="{{ __('duration (minutes)') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-calculator">
                                            <select id="activity" class="form-control" required>
                                                ...
                                                <option value="1.3">{{ __('Sitting') }} </option>
                                                <option value="1.5">{{ __('Standing') }} </option>
                                                <option value="4">{{ __('Walking (slow)') }} </option>
                                                <option value="6">{{ __('Walking (moderate)') }} </option>
                                                <option value="8">{{ __('Walking (fast)') }} </option>
                                                <option value="5">{{ __('Cycling (slow)') }} </option>
                                                <option value="8">{{ __('Cycling (moderate)') }} </option>
                                                <option value="12">{{ __('Cycling (fast)') }} </option>
                                                <option value="6">{{ __('Swimming (slow)') }} </option>
                                                <option value="8">{{ __('Swimming (moderate)') }} </option>
                                                <option value="10">{{ __('Swimming (fast)') }} </option>
                                                <option value="8">{{ __('Jogging') }} </option>
                                                <option value="12">{{ __('Running') }} </option>
                                                <option value="15">{{ __('Sprinting') }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
    ...
    @push('js')
        <script src="{{ asset('web/js/calcs/calorie-burn.js') }}"></script>
    @endpush
@endsection
