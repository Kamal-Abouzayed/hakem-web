...
@section('content')
    <form class="card shadow mb-4" action="{{ route('dashboard.goals.store') }}" method="POST" enctype="multipart/form-data"
        id="createGoalForm">
        @csrf
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">إضافة هدف</h6>
        </div>
        <div class="card-body">
