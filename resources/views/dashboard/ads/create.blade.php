...
@section('content')
    <form class="card shadow mb-4" action="{{ route('dashboard.ads.store') }}" method="POST" enctype="multipart/form-data"
        id="createAdForm">
        @csrf
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" name="btn_text_ar" autocomplete="btn_text_ar"
                        value="{{ old('btn_text_ar') }}" required>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" name="btn_text_en" autocomplete="btn_text_en"
                        value="{{ old('btn_text_en') }}" required>
