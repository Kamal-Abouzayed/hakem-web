        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <textarea class="form-control" name="answer_ar" id="" cols="30" rows="10" required>{{ old('answer_ar', $faq->answer_ar) }}</textarea>
                ...
                <div class="form-group col-6">
                    ...
                    <textarea class="form-control" name="answer_en" id="" cols="30" rows="10" required>{{ old('answer_en', $faq->answer_en) }}</textarea>
