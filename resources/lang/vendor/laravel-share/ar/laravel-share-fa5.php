...
// custome
return [
    'facebook' => '<li><a target="_blank"  href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/facebook-logo2.png" alt=""></a></li>',
    'twitter' => '<li><a  target="_blank" href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/twitter.png" alt=""></a></li>',
    'linkedin' => '<li><a target="_blank"  href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/linkedin.png" alt=""></a></li>',
    'whatsapp' => '<li><a target="_blank" href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/whatsapp.png" alt=""></a></li>',
    'pinterest' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><span class="fab fa-pinterest"></span></a></li>',
    'reddit' => '<li><a target="_blank" href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><span class="fab fa-reddit"></span></a></li>',
    'telegram' => '<li><a target="_blank" href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><span class="fab fa-telegram"></span></a></li>',
];
