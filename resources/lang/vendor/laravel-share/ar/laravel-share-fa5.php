...
// custome
return [
    'facebook' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/facebook-logo2.png" alt=""></a></li>',
    'twitter' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/twitter.png" alt=""></a></li>',
    'linkedin' => '<li><a href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><img src="http://127.0.0.1:8000/web/images/linkedin.png" alt=""></a></li>',
